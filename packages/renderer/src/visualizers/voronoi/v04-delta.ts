...
const metadata: VisualizerMetadata = {
  ...
  params: [
    { key: 'seedCount', label: 'Seeds', min: 16, max: 128, step: 1, initial: 48, category: 'appearance', description: 'Number of Voronoi sites' },
    { key: 'driftSpeed', label: 'Drift Speed', min: 0.0, max: 1.0, step: 0.05, initial: 0.2, category: 'appearance' },
    { key: 'edgeGlow', label: 'Edge Glow', min: 0.2, max: 2.0, step: 0.1, initial: 0.9, category: 'appearance' },
    { key: 'faceOpacity', label: 'Face Opacity', min: 0.05, max: 0.8, step: 0.05, initial: 0.45, category: 'appearance' },
    { key: 'explodeAmount', label: 'Explode', min: 0.0, max: 1.5, step: 0.05, initial: 0.25, category: 'appearance', description: 'How far cells separate from their centroids' },
    { key: 'radiusContrast', label: 'Radius Contrast', min: 0.0, max: 2.0, step: 0.1, initial: 1.0, category: 'appearance', description: 'How strongly seed radii differ' },
