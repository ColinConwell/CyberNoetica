 ...
 *
 * Math:
 *   A Voro++ spherical wall clips every cell to the interior of a ball
 *   (approximated by a tangent plane at the nearest surface point). Seeds
...
const metadata: VisualizerMetadata = {
  ...
  params: [
    { key: 'seedCount', label: 'Seeds', min: 16, max: 128, step: 1, initial: 56, category: 'appearance', description: 'Shell + core site count' },
    { key: 'driftSpeed', label: 'Drift Speed', min: 0.0, max: 1.0, step: 0.05, initial: 0.18, category: 'appearance' },
    { key: 'edgeGlow', label: 'Edge Glow', min: 0.2, max: 2.0, step: 0.1, initial: 1.15, category: 'appearance' },
    { key: 'faceOpacity', label: 'Face Opacity', min: 0.05, max: 0.8, step: 0.05, initial: 0.32, category: 'appearance' },
    { key: 'explodeAmount', label: 'Explode', min: 0.0, max: 1.5, step: 0.05, initial: 0.2, category: 'appearance', description: 'How far cells separate from their centroids' },
    { key: 'sphereRadius', label: 'Sphere Radius', min: 1.0, max: 2.4, step: 0.05, initial: 1.85, category: 'appearance', description: 'Radius of the clipping sphere' },
    ...
    { key: 'rmsToRadius', label: 'RMS → Radius', min: 0.0, max: 2.0, step: 0.1, initial: 1.0, category: 'audio-mapping', description: 'How strongly volume breathes the sphere wall' },
