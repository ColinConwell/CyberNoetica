...
const metadata: VisualizerMetadata = {
  ...
  params: [
    { key: 'seedCount', label: 'Seeds', min: 27, max: 125, step: 1, initial: 64, category: 'appearance', description: 'Lattice site count (rounded to a cube)' },
    { key: 'driftSpeed', label: 'Drift Speed', min: 0.0, max: 1.0, step: 0.05, initial: 0.15, category: 'appearance' },
    { key: 'edgeGlow', label: 'Edge Glow', min: 0.2, max: 2.0, step: 0.1, initial: 1.1, category: 'appearance' },
    { key: 'faceOpacity', label: 'Face Opacity', min: 0.05, max: 0.8, step: 0.05, initial: 0.22, category: 'appearance' },
    { key: 'explodeAmount', label: 'Explode', min: 0.0, max: 1.5, step: 0.05, initial: 0.15, category: 'appearance', description: 'How far cells separate from their centroids' },
    { key: 'bassToJitter', label: 'Bass → Jitter', min: 0.0, max: 2.0, step: 0.1, initial: 1.0, category: 'audio-mapping', description: 'How strongly bass rattles the lattice' },
