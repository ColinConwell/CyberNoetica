...
const MANIFEST_ENTRIES: Omit<VisualizerManifestEntry, 'documentation'>[] = [
  ...
  { type: 'voronoi-beta', label: 'Voronoi (β)', description: '3D polyhedral foam via Voro++', group: '3d',
    loader: () => import('./voronoi/v02-beta.js') },
  { type: 'voronoi-gamma', label: 'Voronoi (γ)', description: 'Periodic crystal foam', group: '3d',
    loader: () => import('./voronoi/v03-gamma.js') },
  { type: 'voronoi-delta', label: 'Voronoi (δ)', description: 'Radical / Laguerre weighted cells', group: '3d',
    loader: () => import('./voronoi/v04-delta.js') },
  { type: 'voronoi-epsilon', label: 'Voronoi (ε)', description: 'Spherical-wall foam globe', group: '3d',
